...
class InfluxSendable implements SendableBuilder {
    ...
    private Map<String, BooleanSupplier> booleanSupplierMap = new HashMap<String, BooleanSupplier>();
    private Map<String, DoubleSupplier> doubleSupplierMap = new HashMap<String, DoubleSupplier>();
    private Map<String, Supplier<String>> stringSupplierMap = new HashMap<String, Supplier<String>>();

    public InfluxSendable(final Map<String, String> tags) {
        tagMap = new HashMap<String, String>(tags);
    }
